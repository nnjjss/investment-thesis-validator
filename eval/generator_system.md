...
5. `expected_evidence_keys` should follow the agent's key naming convention (`fmp.income_statement.<ticker>.<YYYY-MM-DD>`, `sec.10-K.<padded_cik>`, `fmp.ratios.<ticker>.<YYYY-MM-DD>`).
